...
//#include "/uboone/app/users/apapadop/uboonecode_v08_00_00_52/srcs/ubana/ubana/AnalysisCode/Secondary_Code/myFunctions.cpp"

//----------------------------------------//

void PRD_3DXSec_Ratio() {
...
//	MCSample.push_back("Genie_v3_0_6_EffSF"); Label.push_back("G18 EffSF Tune");			
	...
	TString XSecFileName = "OutputFiles/All_XSecs_3D_ECal.root";
	...
	for (int icanvas = 0; icanvas < NCanvases; icanvas++) {
		...
		for (int ipad = 0; ipad < NPads; ipad++) {
			...
			for (int iplot = 0; iplot < NPlots; iplot++) {
				...
				PlotCanvas->cd();
				TString PadName = "pad_" + TString( std::to_string(ipad) ) + "_" + TString( std::to_string(iplot) );
